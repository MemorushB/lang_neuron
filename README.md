...
```
bash main_prod_env.sh "llama-2-7b compute_responses Relation person_sport_position 2000 on_p50 expertise_limited_2000_both"
```
...
```
bash main_prod_env.sh "llama-2-7b compute_expertise Relation city_in_country 2000 on_p50 expertise_limited_2000_both"
```
...
```
bash main_prod_env.sh "llama-2-7b limit_expertise Relation city_in_country 2000 on_p50 expertise_limited_2000_both"
```
